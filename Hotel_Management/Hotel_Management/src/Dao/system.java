...
public class system implements ActionListener {
	...
	private void initialize() {
		...
		returnOut.setBounds(174, 226, 93, 23);
		frame.getContentPane().add(returnOut);
        returnOut.addActionListener(this);
        
		queryAll = new JButton("查询餐厅");
		queryAll.setBounds(259, 192, 93, 23);
		frame.getContentPane().add(queryAll);
